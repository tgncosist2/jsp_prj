...
<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8" info="" session="true" buffer="8kb" autoFlush="true" 
	isELIgnored="false"
...
pageContext.setAttribute("msg", "오늘은 월요일 입니다.");
...
<body>
	...
	<main>
		...
		<input type="button" class="btn btn-success" value="클릭" onclick="print('EL의 사용')"/>
		
		<%
		if(new Random().nextBoolean()) {
			throw new Exception("예외가 강제로 발생했습니다!");
		}
		%>
