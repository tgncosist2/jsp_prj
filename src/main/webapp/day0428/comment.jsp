...
<body>
	...
	<main>
		...
		<%@ include file="../day0425/declaration.jsp" %>
		...
		HTML 주석 : <!-- <%= name %> --><br>
		<!-- Java 주석 : JSP > java > class에 포함 X > instance 생성 X > HTML로 X -->
		Java 주석 : <%= /* 이것은 이름변수 임.*/ name %><br>
		<!-- JSP 주석 : JSP > java 에서 주석 > class에 포함 X > instance 생성 X > HTML로 X -->
		JSP 주석 : <%-- <%= name %> --%>
