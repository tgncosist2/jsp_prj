<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8" info="나는 다른 JSP가 잘못했을때 대신 응답페이지!"
	isErrorPage="true"%>
<!DOCTYPE html>
<html>
<head>
	...
	<main>
		<div id="container">
			<div style="margin: auto;">
				<img src="https://www.sist.co.kr/img/404_img.jpg" /><br>
			</div>
			이용에 불편을 드려 죄송합니다. 페이지의 주소가 잘못 입력되었거나 변경 혹은 삭제되어 요청하신 페이지를 찾을 수 없습니다.
			입력하신 주소가 정확한지 다시 한번 확인해주시기 바랍니다. 관련 문의사항은 고객센터로 알려주시면 친절하게 안내해
			드리겠습니다.
