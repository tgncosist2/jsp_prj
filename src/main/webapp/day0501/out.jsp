...
<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8" info="" session="false"%>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
...
<body>
	...
	<main>
		...
		if(new Random().nextBoolean()) {
			out.println("<strong>야호 목요일이다</strong><br>");
		}
		%>
		...
		<div>
		<%
		String[] url={"https://daum.net","https://naver.com","https://google.com"};
		%>
		
		<a href="<%out.println(url[new Random().nextInt(0,3)]);%>">URL</a>
		...
		session.setAttribute("asd", "zxc");
		
		session.setMaxInactiveInterval(60 * 31 + 16);
		session.removeAttribute("asd");
		session.invalidate();
		%>
		
		<a href="../day0430/use_encoder.jsp">야호</a>
