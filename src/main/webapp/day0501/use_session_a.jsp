<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8" info="세션의 사용"%>
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core"%>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
<title>세션을 사용해보자.</title>
			...
			<c:choose>
				<c:when test="${ empty sessionScope.name }">
					<form action="use_session_b.jsp" method="GET">
						이름<input type="text" name="name" id="name" /> <input type="text"
							style="display: none;" /> <input type="button" value="제출"
							class="btn btn-success" id="btn" />
					</form>
