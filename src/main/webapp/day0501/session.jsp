...
<body>
	...
	<main>
		...
		if(request.getRequestedSessionId().equals("F6DA7EBEF5000D9E6FD044FD026CD62E")) {
		...
		Cookie c = new Cookie("yaho","1234");
		c.setMaxAge(20);
		c.setPath("/");
		response.addCookie(c);
		
		for (Cookie coo : request.getCookies()) {
			if(coo.getName().equals("yaho")) {
				System.out.print(coo.getValue());
			}
		}
		
		%>
		
		<a href="redirect_a.jsp">asd</a>
